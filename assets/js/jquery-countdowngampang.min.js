...
var element=$(this);var settings={rampung:undefined,labels:!0,labelsOptions:{lang:{days:'Days',hours:'Hours',minutes:'Minutes',seconds:'Seconds'},},style:{element:'',labels:!1,textResponsive:0.5,days:{gauge:{thickness:0.02,bgColor:'#ff8503',fgColor:'#ff8503',lineCap:'butt'},textCSS:''},hours:{gauge:{thickness:0.02,bgColor:'rgba(0, 0, 0, 0)',fgColor:'rgba(0, 0, 0, 1)',lineCap:'butt'},textCSS:''},minutes:{gauge:{thickness:0.02,bgColor:'rgba(0, 0, 0, 0)',fgColor:'rgba(0, 0, 0, 1)',lineCap:'butt'},textCSS:''},seconds:{gauge:{thickness:0.02,bgColor:'rgba(0, 0, 0, 0)',fgColor:'rgba(0, 0, 0, 1)',lineCap:'butt'},textCSS:''}},onEndCallback:function(){if(window.console&&window.console.log){window.console.log("[CountdownGampang::isRampung] Wayae, wayae ......")}}};if(!options.rampung){throw 'Parameter options.rampung must passed bro.'}
settings=$.extend(!0,settings,options);if(typeof callback!==undefined){settings.onEndCallback=callback}
function prepareTemplate(){element.append('<div class="ClassyCountdown-wrapper">'+'<div class="ClassyCountdown-days">'+'<input type="text" />'+'<div class="ClassyCountdown-value"><div></div><span></span></div>'+'</div>'+'<div class="ClassyCountdown-hours">'+'<input type="text" />'+'<div class="ClassyCountdown-value"><div></div><span></span></div>'+'</div>'+'<div class="ClassyCountdown-minutes">'+'<input type="text" />'+'<div class="ClassyCountdown-value"><div></div><span></span></div>'+'</div>'+'<div class="ClassyCountdown-seconds">'+'<input type="text" />'+'<div class="ClassyCountdown-value"><div></div><span></span></div>'+'</div>'+'</div>');element.find('.ClassyCountdown-days input').knob($.extend({width:'100%',displayInput:!1,readOnly:!0,max:365},settings.style.days.gauge));element.find('.ClassyCountdown-hours input').knob($.extend({width:'100%',displayInput:!1,readOnly:!0,max:24},settings.style.hours.gauge));element.find('.ClassyCountdown-minutes input').knob($.extend({width:'100%',displayInput:!1,readOnly:!0,max:60},settings.style.minutes.gauge));element.find('.ClassyCountdown-seconds input').knob($.extend({width:'100%',displayInput:!1,readOnly:!0,max:60},settings.style.seconds.gauge));element.find('.ClassyCountdown-wrapper > div').attr("style",settings.style.element);element.find('.ClassyCountdown-days .ClassyCountdown-value').attr('style',settings.style.days.textCSS);element.find('.ClassyCountdown-hours .ClassyCountdown-value').attr('style',settings.style.hours.textCSS);element.find('.ClassyCountdown-minutes .ClassyCountdown-value').attr('style',settings.style.minutes.textCSS);element.find('.ClassyCountdown-seconds .ClassyCountdown-value').attr('style',settings.style.seconds.textCSS);if(settings.labels){element.find(".ClassyCountdown-days .ClassyCountdown-value > span").html(settings.labelsOptions.lang.days);element.find(".ClassyCountdown-hours .ClassyCountdown-value > span").html(settings.labelsOptions.lang.hours);element.find(".ClassyCountdown-minutes .ClassyCountdown-value > span").html(settings.labelsOptions.lang.minutes);element.find(".ClassyCountdown-seconds .ClassyCountdown-value > span").html(settings.labelsOptions.lang.seconds);element.find(".ClassyCountdown-value > span").attr("style",settings.labelsOptions.style)}}
